    ...
    <div className={styles.filter}>
      ...
      <div className={styles.splitter}>
        <div className={styles.sequence}>
          ...
          <div className={styles.tuple}>
            <div className={styles.dictionary}>
              <img className={styles.arrayIcon} alt="" src="/star-6-1.svg" />
              ...
              <img className={styles.arrayIcon4} alt="" src="/star-10-1.svg" />
            </div>
          </div>
        </div>
        <div
        ...
        <div className={styles.linkedList}>
          ...
          <div className={styles.stackPointer}>
            <img
              className={styles.stackPointerChild}
              loading="lazy"
              alt=""
              src="/group-2475.svg"
            />
